...
from core.common import restarts, spstopper, svrhelpers
from servers.testserver import deployment as dep, messaging as msg, console as con
...
class Server(svrabc.Server):
    ...
    async def run(self):
        ...
        server.use_pipeinsvc(self._pipeinsvc).wait_for_started(msg.SERVER_STARTED_FILTER, 10)
        await server.run()
