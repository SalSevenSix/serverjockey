...
from servers.hytale import deployment as dep, messaging as msg
...
class Server(svrabc.Server):
    ...
    def __init__(self, context: contextsvc.Context):
        ...
        self._stopper = spstopper.ServerProcessStopper(context, 20.0, 'exit')
    ...
    async def run(self):
        ...
        server.use_pipeinsvc(self._pipeinsvc).wait_for_started(msg.SERVER_STARTED_FILTER, 60)
        await server.run()
