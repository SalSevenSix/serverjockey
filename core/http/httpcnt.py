...
CACHE_CONTROL, CACHE_CONTROL_NO_STORE = 'Cache-Control', 'no-store'
ACCEPT_RANGES, ACCEPT_RANGES_NONE = 'Accept-Ranges', 'none'
...
MIME_APPLICATION_YAML = 'application/yaml'
MIME_APPLICATION_TOML = 'application/toml'
...
_TEXT_TYPES = (
    MIME_TEXT_PLAIN, MIME_TEXT_HTML, MIME_TEXT_CSS, MIME_APPLICATION_JSON, MIME_APPLICATION_YAML, MIME_APPLICATION_TOML,
    MIME_APPLICATION_XML, MIME_APPLICATION_JAVASCRIPT, MIME_APPLICATION_TYPESCRIPT, MIME_IMAGE_SVGXML)
...
_CONTENT_TYPES = {
    ...
    'yml': ContentTypeImpl(MIME_APPLICATION_YAML),
    'yaml': ContentTypeImpl(MIME_APPLICATION_YAML),
    'toml': ContentTypeImpl(MIME_APPLICATION_TOML),
