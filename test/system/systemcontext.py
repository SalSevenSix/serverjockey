...
class _SystemTestContext:
    ...
    def __init__(self):
        ...
        self._context = contextsvc.Context(dict(
            cwd=cwd, home=home, logfile=None, tempdir=tempdir, host=None, port=None, modules=None, single=None,
            showtoken=False, noupnp=True, dbfile=None, debug=True, trace=False, secret='token', stime=None,
            scheme=_SCHEME, env=os.environ.copy()))
