...
<div class="content">
  ...
  <p><span class="has-text-weight-bold">Last Activity:</span>&nbsp;
    ...
    {:else if lastActivity === null}
      <span class="is-italic">world save does not exist</span>
    {:else if lastActivity === 0}
      <span class="is-italic">world save found</span>
    {:else}
      <span class="notranslate">{shortISODateTimeString(lastActivity)}</span>
    {/if}
  </p>
