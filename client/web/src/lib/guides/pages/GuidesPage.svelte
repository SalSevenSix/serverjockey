<script>
  ...
  import GeneralGuides from '$lib/guides/common/GeneralGuides.svelte';
  import GameServerGuides from '$lib/guides/common/GameServerGuides.svelte';
  import AdvancedGuides from '$lib/guides/common/AdvancedGuides.svelte';
</script>
...
<div class="columns">
  ...
  <div class="column is-two-thirds content">
    ...
    <ul>
      <li><a href="#generalguides" use:scrollto={'#generalguides'}>General Guides</a></li>
      <li><a href="#gameserverguides" use:scrollto={'#gameserverguides'}>Game Server Guides</a></li>
      <li><a href="#advancedguides" use:scrollto={'#advancedguides'}>Advanced Guides</a></li>
    </ul>
  </div>
</div>
